...
function CakeVariants({ _product, updateVariantEvent, city }: PropTypes) {
  ...
  useEffect(() => {
    if (product) {
      ...
      // checking on variant
      if (product.cakeVarient.double?.fieldOne) {
        // two tier variant
        setVariant("double");
        updateDoublePrice();
        onUpdateVariant(_selectedVariant);
      } else if (product.cakeVarient.threeTier?.fieldOne) {
        // three tier variant
        ...
        <>
          ...
          <div className="col-md-6">
            <DoubleTheQtyVariant
              ...
              onUpdateVariant={onUpdateVariant}
              description={product.cakeVarient?.double?.fieldTwo}
      ...
      {variant === "three-tier" && (
        <>
          <div className="col-md-4">
            <ClassicVariant
              onUpdateVariant={onUpdateVariant}
              description={product.cakeVarient?.threeTier?.fieldOne}
              price={standardPrice.current}
              priceUSD={standardPriceUSD.current}
              isSelected={_selectedVariant === "classic"}
            />
          ...
          <div className="col-md-4">
            <DoubleTheQtyVariant
              title="Make It Special"
              onUpdateVariant={onUpdateVariant}
              description={product.cakeVarient?.threeTier?.fieldTwo}
              price={doublePrice.current}
              priceUSD={doublePriceUSD.current}
              isSelected={_selectedVariant === "double"}
            />
          ...
          <div className="col-md-4">
            <PremiumVariant
              ...
              onUpdateVariant={onUpdateVariant}
              description={product.cakeVarient?.threeTier?.fieldThree}
